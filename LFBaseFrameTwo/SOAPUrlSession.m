...
+ (void)didSeeActionWithartid:(NSString *)artid
    ...
    NSString *urlStr = @"http://47.92.86.242/bidapp/Api/index.php/Engagements/addToReadHistory";
    NSLog(@"方法名: %@", urlStr);
...
+ (void)deleteSeeActionWithartid:(NSString *)artid
    ...
    NSString *urlStr = @"http://47.92.86.242/bidapp/Api/index.php/Engagements/deleteActionData";
    NSLog(@"方法名: %@", urlStr);
...
+ (void)getCollectWithPage:(NSString *)page
    ...
    NSString *urlStr = @"http://47.92.86.242/bidapp/Api/index.php/Articles/selectMbrActionArts";
    NSLog(@"方法名: %@", urlStr);
...
//    [manager.requestSerializer setValue:@"application/json; charset=utf-8" forHTTPHeaderField:@"Content-Type"];
    ...
    NSString *urlStr = @"http://47.92.86.242/bidapp/Api/index.php/Suggestions/addSuggestion";
    NSLog(@"方法名: %@", urlStr);
...
+ (void)yourLikeCur_Page:(NSString *)cur_page
    ...
    NSString *urlStr = @"http://47.92.86.242/bidapp/Api/index.php/GuessFavorite/selectGuessFavorite";
    NSLog(@"方法名: %@", urlStr);
...
+ (void)getYourLikeDetialId:(NSString *)Id
    ...
    NSString *urlStr = @"http://47.92.86.242/bidapp/Api/index.php/GuessFavorite/selectGuessDetil";
    NSLog(@"方法名: %@", urlStr);
...
//    [manager.requestSerializer setValue:@"multipart/form-data" forHTTPHeaderField:@"enctype"];
    ...
    NSString *urlStr = @"http://47.92.86.242/bidapp/Api/index.php/Message/selectMyMessages";
    NSLog(@"方法名: %@", urlStr);
...
+ (void)todayStudyCur_Page:(NSString *)cur_page
    ...
    NSString *urlStr = @"http://47.92.86.242/bidapp/Api/index.php/Tstu/selectTstuArticles";
    NSLog(@"方法名: %@", urlStr);
...
+ (void)todayStudyDetialId:(NSString *)Id
    ...
    NSString *urlStr = @"http://47.92.86.242/bidapp/Api/index.php/Tstu/getTsArtInfo";
    NSLog(@"方法名: %@", urlStr);
...
// 最新加入和热门推荐
+ (void)hotAneNewWebsType:(NSString *)websType      // (0 最新，1热门)
    ...
    NSString *urlStr = @"http://47.92.86.242/bidapp/Api/index.php/Websites/selectWebs";
    NSLog(@"方法名: %@", urlStr);
...
+ (void)hotAneNewWebsHeaderType:(NSString *)websType      // (0 最新，1热门)
    ...
    NSString *urlStr = @"http://47.92.86.242/bidapp/Api/index.php/Websites/selectSubcribeWebs";
    NSLog(@"方法名: %@", urlStr);
...
//    [manager.requestSerializer setValue:@"multipart/form-data" forHTTPHeaderField:@"enctype"];
    ...
    NSString *urlStr = @"http://47.92.86.242/bidapp/Api/index.php/Members/selectVersionsUpdateForios";
    NSLog(@"方法名: %@", urlStr);
